...
public class Alimento extends Producto{
    ...
    private static final double IMPUESTO_PRODUCTO = 0.05;
    private static final double DESCUENTO_PRODUCTO = 0.15;
    private static final int MIN_PRECIO_POR_DESCUENTO = 100;
